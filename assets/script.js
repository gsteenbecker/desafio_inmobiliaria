const propiedadesVenta = [
  ...
  if (ventaList && alquilerList) {
    renderizarPropiedades(propiedadesVenta.slice(0, 3), ventaList)
    renderizarPropiedades(propiedadesAlquiler.slice(0, 3), alquilerList)
  }
  ...
  if (document.location.pathname.includes('propiedades_venta.html')) {
    renderizarPropiedades(propiedadesVenta, document.getElementById('venta-list'))
  }
  
  if (document.location.pathname.includes('propiedades_alquiler.html')) {
    renderizarPropiedades(propiedadesAlquiler, document.getElementById('alquiler-list'))
  }
